...
void test_up_empty(){
	...
	if (up_empty(B.players[0], B) == 0){
		couleur("32");
		printf("up_empty passed\n");
		couleur("0");
	} else {
		couleur("31");
		printf("up_empty failed\n");
		couleur("0");
	}
}
...
void test_choose_directions(){
	...
	if (flag){
		couleur("32");
		printf("choose_directions passed\n");
		couleur("0");
	} else {
		couleur("31");
		printf("choose_directions failed\n");
		couleur("0");
	}
}
...
void test_del_duplicates(){
	...
	if (B.directions[0].x == -1 && B.directions[0].x == -1 && B.directions[0].x == -1 && B.directions[0].x == -1 ) {
		couleur("32");
		printf("del_duplicates passed\n");
		couleur("0");
	} else {
		couleur("31");
		printf("del_duplicates failed\n");
		couleur("0");
	}
}	
void test_move(){
...
void test_move_all(){
	...
	if (flag){
		couleur("32");
		printf("move_all passed\n");
		couleur("0");
	} else {
		couleur("31");
		printf("move_all failed\n");
		couleur("0");
	}
}
...
void test_is_traped(){
	...
	if (flag){
		couleur("32");
		printf("is_traped passed\n");
		couleur("0");	
	} else {
		couleur("31");
		printf("is_traped failed\n");
		couleur("0");
	}
}
...
void test_initialize_arena(){
	...
	if (comp == NB_PLAYERS) {
		couleur("32");
		printf("initialize_arena passed\n");
		couleur("0");
	} else {
		couleur("31");
		printf("initialize_arena failed\n");
		couleur("0");
	}
